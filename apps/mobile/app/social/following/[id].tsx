    ...
    <Box flex={1} bg={COLORS.luxuryBlack}>
      ...
      <Box px="$6" py="$4" borderBottomWidth={1} borderColor={COLORS.darkBorder}>
        <HStack alignItems="center">
          ...
          <Heading color={COLORS.textPrimary} size="xl" fontWeight="$black">Following</Heading>
        </HStack>
      </Box>
      ...
      {loading && !refreshing ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Center py="$16" px="$6">
              <Text color={COLORS.textSecondary} textAlign="center" fontWeight="$medium">Not following anyone yet.</Text>
            </Center>
          }
        />
      )}
